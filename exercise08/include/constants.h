...
int timeslices, brownianBridgeReconstructions, brownianBridgeAttempts,
    brownianMotionReconstructions;
int MCSTEPS, equilibration, blocks, histogram_bins;
int timeslices_averages_start, timeslices_averages_end;
double temperature, imaginaryTimePropagation, delta_variational,
    delta_translation;
